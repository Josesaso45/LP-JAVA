...
<body>
    ...
    <div class="container mt-4">
        <h3>Editar Bus: ${bus.placa}</h3>
        <form action="bus" method="post" class="card p-4">
            <input type="hidden" name="accion" value="actualizar"/>
            <div class="mb-3">
                <label for="placa" class="form-label">Placa</label>
                <input type="text" class="form-control" id="placa" name="placa" value="${bus.placa}" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="capacidad" name="capacidad" value="${bus.capacidad}" required>
            </div>
